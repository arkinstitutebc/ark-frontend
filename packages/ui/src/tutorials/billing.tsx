  ...
  sections: [
    {
      ...
      body: (
        <p>
          Billing tracks <b>accounts receivable (AR)</b> for TESDA students — what's owed, what's
          been paid, and what's outstanding. Each receivable is tied to a batch.
        </p>
      ),
    },
    {
