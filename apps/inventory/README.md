...
→ https://inventory.arkinstitutebc.com
...
From monorepo root: `bun install && bun run dev:inventory`. Backend must also be running ([`ark-services`](https://github.com/arkinstitutebc/ark-services)).
