import { ArrowLeft, ChevronLeft, ChevronRight, LogOut, Receipt, TrendingUp } from "lucide-solid"
      ...
      <div class="flex items-center gap-3 px-4 h-14 border-b border-gray-100 flex-shrink-0">
        ...
        <Show when={!collapsed()}>
          <div class="overflow-hidden">
            <p class="text-sm font-semibold text-gray-900 truncate">Billing</p>
            <p class="text-[11px] text-gray-500 truncate">TESDA & AR Tracking</p>
          </div>
        </Show>
      </div>
