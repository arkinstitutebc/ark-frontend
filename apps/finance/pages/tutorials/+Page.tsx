  ...
  },
  {
    ...
    body: (
      <p>
        ...
        <b>Download PDF</b> for a print-ready segmented income statement. Numbers come straight from
        the transaction ledger — they reflect what was recorded, not what's pending.
      </p>
    ),
  },
  {
...
export default function FinanceTutorialPage() {
  return (
    <TutorialShell
