    ...
    body: (
      <>
        ...
        <ol class="list-decimal pl-5 space-y-1.5">
          ...
          <li>
            Review the entries, adjust if needed, then click <b>Process</b>. The PDF payroll report
            becomes downloadable.
          </li>
        </ol>
        <p>
          Processed periods are locked. To fix mistakes, create a new period with adjustments rather
...
export default function HrTutorialPage() {
  return (
    <TutorialShell
