...
### Added
- **Training batch metadata** — Add/Edit Batch now captures optional Batch No., RQM, and Weekly Schedule. Batch list and detail views display the values alongside the generated batch code and date range.
